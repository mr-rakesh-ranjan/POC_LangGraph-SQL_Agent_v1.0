...
from core.toolkit import db_query_tool, get_list_tables_tool, get_schema_tool
from prompt import query_check_prompt_func
...
def model_check_query(state: State) -> dict[str, list[AIMessage]]:
    ...
    """
    return {"messages": [query_check_prompt_func([state["messages"][-1]])]}
